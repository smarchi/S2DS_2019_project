...
merged_df['Reach'],_,_ = function.make_all_transform(merged_df,'Reach',
...
df_smote = function.apply_smote(df_smote, smote_cond,cat_vars=cat_variables,
                                one_hot=False)

#build one-hot encoded matrix with patsy
Y_train,X_train_encoded = patsy.dmatrices(formula,df_smote,
